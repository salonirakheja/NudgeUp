...
export const ProfileCard = () => {
  ...
  const [memberSince, setMemberSince] = useState<string>('Nov 2024');
  ...
  // Load saved avatar and name from localStorage
  useEffect(() => {
    ...
    // Set member since date from account creation
    if (accountCreatedAt) {
      setMemberSince(formatMemberSince(accountCreatedAt));
    }
  }, []);
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-4">
        {/* Avatar - Larger size */}
        <div className="w-16 h-16 bg-white rounded-full shadow-md flex justify-center items-center flex-shrink-0 overflow-hidden">
          {avatarImage ? (
            <img 
              src={avatarImage} 
              alt="Profile" 
